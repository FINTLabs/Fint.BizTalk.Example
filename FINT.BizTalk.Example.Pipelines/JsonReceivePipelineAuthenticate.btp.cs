namespace FINT.BizTalk.Example.Pipelines
{
    ...
    public sealed class JsonReceivePipelineAuthenticate : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"      <Value xsi:type=\"xsd:string\">AccessToken</Value>            </Property>            <Property N"+
"ame=\"RootNodeNamespace\">              <Value xsi:type=\"xsd:string\">http://FINT.BizTalk.Example.Schem"+
"as.AccessTokenResponse</Value>            </Property>            <Property Name=\"AddMessageBodyForEm"+
"ptyMessage\">              <Value xsi:type=\"xsd:boolean\">false</Value>            </Property>        "+
"  </Properties>          <CachedDisplayName>JSON decoder</CachedDisplayName>          <CachedIsManag"+
"ed>true</CachedIsManaged>        </Component>      </Components>    </Stage>    <Stage>      <Policy"+
"FileStage _locAttrData=\"Name\" _locID=\"2\" Name=\"Disassemble\" minOccurs=\"0\" maxOccurs=\"-1\" execMethod="+
"\"FirstMatch\" stageId=\"9d0e4105-4cce-4536-83fa-4a5040674ad6\" />      <Components>        <Component> "+
"         <Name>Microsoft.BizTalk.Component.XmlDasmComp,Microsoft.BizTalk.Pipeline.Components, Versio"+
"n=3.0.1.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35</Name>          <ComponentName>XML disas"+
"sembler</ComponentName>          <Description>Streaming XML disassembler</Description>          <Ver"+
"sion>1.0</Version>          <Properties>            <Property Name=\"EnvelopeSpecNames\">             "+
" <Value xsi:type=\"xsd:string\" />            </Property>            <Property Name=\"EnvelopeSpecTarge"+
"tNamespaces\">              <Value xsi:type=\"xsd:string\" />            </Property>            <Proper"+
"ty Name=\"DocumentSpecNames\">              <Value xsi:type=\"xsd:string\" />            </Property>    "+
...
" </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "fa191bbc-3c4b-48ab-adc1-9c54383276ed";
        
        public JsonReceivePipelineAuthenticate()
        {
...
" <Value xsi:type=\"xsd:string\">AccessToken</Value>    </Property>    <Property Name=\"RootNodeNamespac"+
"e\">      <Value xsi:type=\"xsd:string\">http://FINT.BizTalk.Example.Schemas.AccessTokenResponse</Value"+
">    </Property>    <Property Name=\"AddMessageBodyForEmptyMessage\">      <Value xsi:type=\"xsd:boolea"+
"n\">false</Value>    </Property>  </Properties></PropertyBag>";
